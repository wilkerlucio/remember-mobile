    ...
    (let [ret   (atom nil)
      ...
      (let [renderf (fn [data]
                      (binding [*reconciler* this
                        ...
                        (println "RENDERING" data target)
                        (let [c (cond
                                  #?@(:cljs [(not (nil? target)) (do
                                                                   (println "RENDER ROOT")
        ...
        (println "GOING PARSEF")
        (parsef)
        (println "AFTER PARSEF")
